// $ANTLR 3.4 Haxe.g 2012-06-01 23:31:49
...
public class HaxeLexer extends Lexer {
    ...
    public final void mCONTINUE() throws RecognitionException {
        try {
            int _type = CONTINUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:533:9: ( 'continue' )
            // Haxe.g:533:13: 'continue'
            {
            match("continue"); 
    ...
    public final void mDEFAULT() throws RecognitionException {
        try {
            int _type = DEFAULT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:534:8: ( 'default' )
            // Haxe.g:534:13: 'default'
            {
            match("default"); 
    ...
    public final void mEXTENDS() throws RecognitionException {
        try {
            int _type = EXTENDS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:539:8: ( 'extends' )
            // Haxe.g:539:13: 'extends'
            {
            match("extends"); 
    ...
    public final void mFINALLY() throws RecognitionException {
        try {
            int _type = FINALLY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:542:8: ( 'finally' )
            // Haxe.g:542:13: 'finally'
            {
            match("finally"); 
    ...
    public final void mIMPLEMENTS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:546:11: ( 'implements' )
            // Haxe.g:546:13: 'implements'
            {
            match("implements"); 
    ...
    public final void mINSTANCEOF() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:548:11: ( 'instanceof' )
            // Haxe.g:548:13: 'instanceof'
            {
            match("instanceof"); 
    ...
    public final void mTRANSIENT() throws RecognitionException {
        try {
            int _type = TRANSIENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:569:10: ( 'transient' )
            // Haxe.g:569:13: 'transient'
            {
            match("transient"); 
    ...
    public final void mTYPEDEF() throws RecognitionException {
        try {
            int _type = TYPEDEF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:571:8: ( 'typedef' )
            // Haxe.g:571:13: 'typedef'
            {
            match("typedef"); 
    ...
    public final void mUNTYPED() throws RecognitionException {
        try {
            int _type = UNTYPED;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:572:8: ( 'untyped' )
            // Haxe.g:572:13: 'untyped'
            {
            match("untyped"); 
    ...
    public final void mVOLATILE() throws RecognitionException {
        try {
            int _type = VOLATILE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:575:9: ( 'volatile' )
            // Haxe.g:575:13: 'volatile'
            {
            match("volatile"); 
    ...
    public final void mFUNCTION() throws RecognitionException {
        try {
            int _type = FUNCTION;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:582:9: ( 'function' )
            // Haxe.g:582:13: 'function'
            {
            match("function"); 
    ...
    public final void mLONGLITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:637:5: ( IntegerNumber LongSuffix )
            // Haxe.g:637:9: IntegerNumber LongSuffix
            {
            mIntegerNumber(); 
    ...
    public final void mINTLITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:641:5: ( IntegerNumber | HexPrefix ( HexDigit )+ )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // Haxe.g:642:9: HexPrefix ( HexDigit )+
                    {
                    mHexPrefix(); 


                    // Haxe.g:642:19: ( HexDigit )+
                    int cnt3=0;
                    loop3:
                    do {
                        int alt3=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Haxe.g:666:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | DIGIT | '_' )* )
            // Haxe.g:666:8: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | DIGIT | '_' )*
            {
    ...
    public final void mFLOATNUM() throws RecognitionException {
        try {
            ...
            // Haxe.g:674:11: ( IntegerNumber EXPONENT |d= IntegerNumber r= ELLIPSIS |d= IntegerNumber DOT IntegerNumber )
            int alt8=3;
            alt8 = dfa8.predict(input);
            switch (alt8) {
                case 1 :
                    // Haxe.g:674:13: IntegerNumber EXPONENT
                    {
                    mIntegerNumber(); 
                    ...
                    break;
                case 2 :
                    // Haxe.g:675:13: d= IntegerNumber r= ELLIPSIS
                    {
                    ...
                    break;
                case 3 :
                    // Haxe.g:682:13: d= IntegerNumber DOT IntegerNumber
                    {
    ...
    class DFA8 extends DFA {
        ...
        public String getDescription() {
            return "674:1: FLOATNUM : ( IntegerNumber EXPONENT |d= IntegerNumber r= ELLIPSIS |d= IntegerNumber DOT IntegerNumber );";
        }
    }
