...
public class CheckParser {
    ...
    public void testModule() {
        ...
        printTree(tree);
        assertEquals(3, ((ExtendedCommonTree) tree).getChildren().size());
    }
    ...
    public void testFunction() {
        ...
        assertEquals("For Function01", 2, ((ExtendedCommonTree) tree).getChildren()
                .size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        Assert.assertEquals("For Function02", 4, ((ExtendedCommonTree) tree)
                .getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        Assert.assertEquals("For Function03", 5, ((ExtendedCommonTree) tree)
                .getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        Assert.assertEquals("For Function04", 4, ((ExtendedCommonTree) tree)
                .getChildren().size());
    }
    ...
    public void testClass() {
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For Class01", 2, ((ExtendedCommonTree) tree).getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For Class02", 3, ((ExtendedCommonTree) tree).getChildren().size());
    }
    ...
    public void testIfStatement() {
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For if01", 2, ((ExtendedCommonTree) tree).getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For if02", 3, ((ExtendedCommonTree) tree).getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For if03", 3, ((ExtendedCommonTree) tree).getChildren().size());
    }
    ...
    public void testForStatement() {
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For For01", 2, ((ExtendedCommonTree) tree).getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For for02", 2, ((ExtendedCommonTree) tree).getChildren().size());
    }
    ...
    public void testWhileStatement() {
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For While01", 2, ((ExtendedCommonTree) tree).getChildren().size());
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For While02", 2, ((ExtendedCommonTree) tree).getChildren().size());
    }
    ...
    public void testSwitchStatement() {
        ...
        printTree(tree);
        assertEquals(0, parser.getNumberOfSyntaxErrors());
        assertEquals("For Switch01", 5, ((ExtendedCommonTree) tree).getChildren().size());
    }
